...
export CUDA_VISIBLE_DEVICES=$5t

echo "TRAINING THE BASELINE"
python models/train_rels.py -m sgcls -model motifnet -nl_obj 0 -val_size 0 -nl_edge 0 -b 6 \
-clip 5 -p 100 -pooling_dim 4096 -lr 1e-3 -ngpu 1 -ckpt /home/xujing/tmp/checkpoints/vg-24.tar -save_dir /home/xujing/tmp/checkpoints/baseline2 \
